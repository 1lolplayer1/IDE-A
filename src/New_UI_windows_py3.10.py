...
style.configure("Treeview", background =  defbackground, foreground = "white",
                rowheight = 25, fieldbackground = defbackground, borderwidth = 0)
...
contextMenu = Menu(app, tearoff = False,
                   background = defbackground, foreground = "white", borderwidth = 0)
...
treeMenu = Menu(tree, tearoff = False,
                background = defbackground, foreground = "white", borderwidth = None)
